...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="../../images/logoaja.png" />
</head>
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-transparent text-left p-5 text-center">
              ...
              <form class="pt-5">
                ...
                <div>
                    @auth
                        <a href="{{ url('/dashboard') }}" class="btn btn-block btn-success btn-lg font-weight-medium">DASHBOARD</a>
                    @else
                        <a href="{{ route('login') }}"   class="fbtn btn-block btn-success btn-lg font-weight-medium">LOGIN</a>
                    @endauth
                </div>
            @endif
              </form>
